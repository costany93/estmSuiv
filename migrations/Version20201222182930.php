 ...
 */
final class Version20201222182930 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE classe DROP filiere_id, DROP numero');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE classe ADD filiere_id INT NOT NULL, ADD numero INT NOT NULL');
